...
Na slikah \ref{fig:crnobeli_kvadratki} in \ref{fig:barvni_kvadratki} lahko opazimo območja, kjer sistem postane kaotičen. Ta so razvidna iz barvne strukture mreže: na nekaotičnih delih se barve lepo (zvezno) spreminjajo, nasprotno pa se na kaotičnih delih barve močno in neurejeno spreminjajo. Vizualno se to kaže kot razdrobljen barvni vzorec ("šum"), kjer so sosednji kvadratki pogosto povsem različnih barv. Takšna barvna nehomogenost odraža občutljivost sistema na začetne pogoje, kar je ena izmed lastnosti kaotičnih sistemov \cite{MIT_Chaos_2025}.
