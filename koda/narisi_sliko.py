...
"""
Risanje slik za dvojno in trojno nihalo (z različnimi barvami).
"""
...
# ko bova končali loh dava mogoč to funkcijo tut kr v slike za animacijo, ker je ta 
# tut ena izmed unih glavnih funkcij s katerimi generirava slike.
def narisi_sliko_s_thetami(resen_list, radij, dt, shr_dir, fps, T_rep, shrani=0):
    ...
    margin = 0.6
    ax.set_xlim(-max_theta1*margin * 16/9, max_theta1*margin * 16/9)
