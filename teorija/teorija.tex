...
za vsak $t_k = k\cdot dt, \ k = 0,1,\ldots, \lfloor \frac{tmax}{dt} \rfloor$ rešimo sistem diferencialnih enačb in dobimo matriko z vrsticami $[\theta_1(t_k), \dot{\theta_1}(t_k), \theta_2(t_k), \dot{\theta_2}(t_k), \ldots, \theta_n(t_k), \dot{\theta_n}(t_k)], \quad k = 0,1,\ldots, \lfloor \frac{tmax}{dt} \rfloor$. Za numerično reševanje diferencialnih sva uporabili funkcijo %\texttt{solve_ivp} (kaj je to zaena numerična metoda).
